...
const animationTimeline = () => {
  ...
  let text = textBoxChars.innerHTML.trim(); // Elimina espacios en blanco extra
  textBoxChars.innerHTML = `<span>${text
    .split("")
    .join("</span><span>")}</span>`;

  const ideaTextTrans = { opacity: 0, y: -20, rotationX: 5, skewX: "15deg" },
    ideaTextTransLeave = { opacity: 0, y: 20, rotationY: 5, skewX: "-15deg" };
